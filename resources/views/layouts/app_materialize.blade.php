...
<body>
    ...
    {{--navbar mobile--}}
      <ul class="side-nav" id="mobile-demo">
        ...
        <li><a href="{{ url('/paket_harga') }}"><i class="fa fa-tasks" aria-hidden="true"></i> Paket Harga</a></li>
        <li><a href="{{ url('/gallery') }}"><i class="material-icons">collections
        </i>
        Gallery</a></li>
        @if (Auth::check())

        <li><a href="/user/profile/{{ Auth::user()->id }}"><i class="material-icons"> account_circle</i> MyProfile</a></li>
        <li><a href="/user/history_booking/{{ Auth::user()->id }}"><i class="fa fa-history" aria-hidden="true"></i>riwayat</a></li>
	        <li><a href="{{ route('logout') }}"
	            onclick="event.preventDefault();
	            document.getElementById('logout-form').submit();">
